...
package adder_pkg;
  ...
  `include "adder_packet.sv"       // UVM transaction (işlem) tanımı
  `include "adder_seqs.sv"         // UVM sequence (işlem sırası) tanımı
  `include "adder_sequencer.sv"    // UVM sequencer (işlem yöneticisi) tanımı
  `include "adder_driver.sv"       // UVM driver (sürücü) tanımı
  `include "adder_monitor.sv"      // UVM monitor (gözlemci) tanımı
